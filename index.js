...
(function() {
  var _, conf, currentNonEnumConf, defType, definedAttrs, filter, log, mixins, options, parentPrototype, staticMethods, useParentContext,
  ...
  defType = {
    defObject: function(propsDefiner) {
      return defType.define(propsDefiner, 'object');
    },
    defClass: function(propsDefiner) {
      return defType.define(propsDefiner, 'class');
    },
  ...
  module.exports = {
    ...
    setNonEnum: function() {
      return conf = defType.makeNonEnumSettings(arguments[0], arguments[1]);
    },
    getNonEnum: function() {
      return conf.nonEnum;
    }
